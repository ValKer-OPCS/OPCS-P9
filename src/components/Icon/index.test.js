...
describe("Icon component", () => {
    ...
    describe("When a icon is created with name youtube", () => {
        it("the icon contain this path hash value 43342876c2fc40e5b2afe621443ff95b and 0af3bfe3ff95607efaf2b66ed8df1253 for the second path", () => {
            render(<Icon name="youtube" />)
            expect(md5(screen.getByTestId("icon").getAttribute('d'))).toEqual('43342876c2fc40e5b2afe621443ff95b')
            expect(md5(screen.getByTestId("icon2").getAttribute('d'))).toEqual('0af3bfe3ff95607efaf2b66ed8df1253')
        });
    });
